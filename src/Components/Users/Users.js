...
const Users = () => {
  ...
  const getData = () => {
    fetch("https://63a44136821953d4f2aea1b0.mockapi.io/studentdata", {
      method: "GET",
    })
  ...
  const DeleteUser = (id) => {
    fetch(`https://63a44136821953d4f2aea1b0.mockapi.io/studentdata/${id}`, {
      method: "DELETE",
...
const getDatas = () => {
  fetch("https://63a44136821953d4f2aea1b0.mockapi.io/mentordata", {
    method: "GET",
  })
    .then((response) => response.json())
...
const DeleteUsers = (id) => {
  fetch(`https://63a44136821953d4f2aea1b0.mockapi.io/mentordata/${id}`, {
    method: "DELETE",
